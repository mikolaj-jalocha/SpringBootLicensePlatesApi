...
@Tag(name = "Voivodeships Rest API Endpoints", description = "Operations related to voivodeships")
public class VoivodeshipRestController {
    ...
    @Operation(summary = "Get every voivodeship", description = "Retrieve a list of every voivodeship.")
